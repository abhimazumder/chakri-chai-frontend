...
const JobLocations = (props) => {
  ...
  const getFieldJSX = (field) => {
    switch (field.FIELD_TYPE) {
      case "Textfield":
        return (
            <Textfield {...field} handleOnChange={handleOnChange} />
        );

      case "Dropdown":
        return (
            <Dropdown {...field} handleOnChange={handleOnChange} />
        );
...
const createLocationObject = () => {
  ...
  dispatchFormData({type: 'CREATE_LOCATION_OBJECT', payload: newLocationObject});
}
